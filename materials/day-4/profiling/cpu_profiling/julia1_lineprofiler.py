...
def calc_pure_python(draw_output, desired_width, max_iterations):
    ...
    # this assert would fail as we're using 100 max_iterations, not 300
...
print "NOTE WE'RE USING JUST 100 MAX_ITER, NOT 300, TO SAVE TIME!"
calc_pure_python(draw_output=False, desired_width=1000, max_iterations=100)
